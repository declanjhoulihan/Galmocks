#####From Simon H. Martin (https://github.com/simonhmartin/twisst) with slight modifications to the plot.twisst.summary function
#to suit our dataset
...
library("ape",  lib = "/workdir/jaa53/")
library("data.table", lib = "/workdir/jaa53/")
library("tools", lib = "/workdir/jaa53/")
